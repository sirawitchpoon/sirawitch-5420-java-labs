...
public class TestMobileDevices3 {
    public static void main(String[] args) {
        ...
        mobileDevices.add(new AppleWatch("Silver", 9400.0, "Apple Watch SE")); // add an object in to
                                                                                    // mobileDivices's list
        System.out.println("=== Before sorting ==="); // print message
        System.out.println(mobileDevices); // print mobileDevices's list(unsorted)
        Collections.sort(mobileDevices, new SortMobileDevicesByMultipleAttrs()); // sort an object in mobileDevice's
                                                                                 // list by multiple condition
