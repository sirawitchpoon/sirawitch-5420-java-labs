...
public class TestAppleWatchNike {
    public static void main(String[] args) {
        AppleWatch appleWatch1 = new AppleWatch("Silver", 9400.0, "Apple Watch Nike SE GPS"); //create an object call "appleWatch1" which in an Applewatch's type
        AppleWatchNike appleWatch2 = new AppleWatchNike("Black", 10000, "Apple Watch Nike SE 7"); //create an object call "appleWatch2" which in an ApplewatchNike's type
        AppleWatchNike appleWatch3 = new AppleWatchNike("Navy", 12000, "Apple Watch Nike SE 8", 6, 8, 48, 140, 150, 8); //create an object call "appleWatch3" which in an ApplewatchNike's type
