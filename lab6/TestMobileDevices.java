...
public class TestMobileDevices {
    public static void main(String[] args) {
        IPadAir ipadAir1 = new IPadAir("Rose Gold", 19900.0, 64.0); //create an object call "ipadAir1" which in an IPadAir's type
        IPadAir ipadAir2 = new IPadAir("Silver", 24900.0, 256.0); //create an object call "ipadAir2" which in an IPadAir's type
